...
import static br.com.ayres.foo.web.rest.TestUtil.sameInstant;
...
import br.com.ayres.foo.repository.BookRepository;
import br.com.ayres.foo.service.dto.BookDTO;
import br.com.ayres.foo.service.mapper.BookMapper;
...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().title(DEFAULT_TITLE).publicationDate(DEFAULT_PUBLICATION_DATE).price(DEFAULT_PRICE);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().title(UPDATED_TITLE).publicationDate(UPDATED_PUBLICATION_DATE).price(UPDATED_PRICE);
        return book;
    }
    ...
    void putNewBook() throws Exception {
        ...
        updatedBook.title(UPDATED_TITLE).publicationDate(UPDATED_PUBLICATION_DATE).price(UPDATED_PRICE);
